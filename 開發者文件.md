...
### v1.4 更新 (2026/01/20) - 靈活教材模板與視覺升級
*   **標題識別升級**：支援「第一章」、「第一節」、「第一步」等中文序號，並能區分「1.1」為標題與「1.」為列表。
*   **視覺樣式優化**：新增 H1 深藍底條、H2 淺藍邊框背景，並自動將 `💡` 與 `⚠️` 列點轉為精美的色塊提示盒。
*   **目錄移除優化**：新增重複內容檢測，能自動清除與後文標題重複的非標準目錄區塊。

### v1.3 更新 (2026/01/19) - AI 配額深度優化
*   **關鍵變更**：關閉啟發式自動偵測，改為**「標記觸發」**。AI 僅在遇到 `【表格開始】` 時啟用。
*   **技術說明**：移除對連續短行、Tab 鍵的自動 AI 判斷，顯著降低 429 錯誤發生率。
